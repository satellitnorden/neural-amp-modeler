# File: parametric_models.py
# Created Date: Wednesday June 22nd 2022
# Author: Steven Atkinson (steven@atkinson.mn)

"""
"Parametric models" -- parametric models where the parametric input is concatenated to the
input samples
"""
    ...
    def _forward(self, params, x):
        ...
        x_augmented = (
            ...
            if self._shape_type == _ShapeType.RNN
                ...
                [
                    x[:, None, :],
                    torch.tile(params[..., None], (1, 1, sequence_length))
                ],
                dim=1,
            )
        )
...
class ParametricLSTM(_ParametricMixin, LSTM):
    @property
    def _shape_type(self) -> _ShapeType:
...
class ParametricWaveNet(_ParametricMixin, WaveNet):
    @property
    def _shape_type(self) -> _ShapeType:
